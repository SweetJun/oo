const state = {
  ...
  privileges: [
    ...
    'dispatch_vehicle_loading_list',
    'dispatch_edit',
    'dispatch_delete',
    'dispatch_borrowing_detail',
    'dispatch_supplement_detail',
    'dispatch_settlement_detail'
  ],
  // 列表data数据
  total: 0,
  isLoading: false,
  ...
  tableHeadList: [
    ...
    {
      label: '借支单',
      prop: 'borrowing_bills',
      width: 150,
      slotName: 'borrowing_bills',
      checked: 1
    },
    {
      label: '补款单',
      prop: 'supplement_bills',
      width: 150,
      slotName: 'supplement_bills',
      checked: 1
    },
    {
      label: '结算单',
      prop: 'settlement_bills',
      width: 150,
      slotName: 'settlement_bills',
      checked: 1
    },
    {
      label: '承运台数',
