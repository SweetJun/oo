<template>
  <div>
    ...
    <p v-if="payType === 'inactive' || payType === 'invalid'" style="color:#FF5200">
      {{promptText}}
    </p>
    <nf-dialog
      title="打款"
    ...
    >
      <div class="remit-content" slot="content">
        ...
        <div class="bank-details">
          <h4>{{remitDetails.settlement_pay_method_display.bank_id_display}}</h4>
          <div>
            <p>{{remitDetails.settlement_pay_method_display.bank_card|formatCarNum}}</p>
            <div>
...
export default {
  ...
  data() {
    return {
      storeModelName: "bankRemittanceModule",
      remitDialog: false,
      remitDetails: {},
      receiptDialog: false,
      ...
      tableOperation: {
        ...
        buttonGroups: [
          scope => {
            return {
              name: "打款",
              isShow: scope.row.acl.can_pay && this.roles.bankcard_pay_records_pay,
              click: ({ row }) => {
