    ...
    >
      <div class="remit-content" slot="content">
        ...
        <div class="bank-details">
          <h4>{{remitDetails.settlement_pay_method_display.name}}</h4>
          <div>
            <p>{{remitDetails.settlement_pay_method_display.account}}</p>
            <div>
...
export default {
  ...
  data() {
    return {
      storeModelName: "wjyRemittanceModule",
      remitDialog: false,
      remitDetails: {},
      receiptDialog: false,
      ...
      tableOperation: {
        ...
        buttonGroups: [
          scope => {
            return {
              name: "打款",
              isShow: scope.row.acl.can_pay && this.roles.wjy_pay_records_pay,
              click: ({ row }) => {
